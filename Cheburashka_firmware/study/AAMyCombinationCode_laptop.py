...
while True:  
    ...
    for (x, y, w, h) in faces:
        ...
        if x > img.shape[0] / 2: #and (xold < img.shape[0] / 2):
          #  open_fullscreen_image('C:\Users\DELL\reposGitHub\Cheburashka\Cheburashka_firmware\study\мордочки\улыбка_другой_бок.png')
            xold = x
        elif x < img.shape[0] / 2: #and (xold > img.shape[0] / 2):
          #  open_fullscreen_image('C:\Users\DELL\reposGitHub\Cheburashka\Cheburashka_firmware\study\мордочки\улыбка_вбок.png')
            xold = x
        #sendToArduino(2)
        print("serial 2")
    if faces == (): pass#open_fullscreen_image('C:\Users\DELL\reposGitHub\Cheburashka\Cheburashka_firmware\study\мордочки\улыбка_прямо.png')
    #print(faces)

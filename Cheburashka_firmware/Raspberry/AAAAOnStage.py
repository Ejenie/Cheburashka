...
while True:      
    ...
    if mom['m00'] > 20000:        
        open_fullscreen_image('/home/ejenie/opencv/sources/samples/python/мордочкиБольшие/страх_вбок.png')     
        sendToArduino(1)
    ...
    momG = cv2.moments(maskG, 255)# (255, 56, 118), (76, 120, 255))#(37, 0, 187), (99, 117, 255))
    try:
        areaG = momG['m00']
